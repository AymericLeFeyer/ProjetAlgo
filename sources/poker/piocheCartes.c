...
void initialisationPioche(Carte *pioche)
{ //initialise le talon puis le mélange dans la pioche
...
int shuffle(Carte *talon, int tailleTalon, Carte *pioche)
{ //permet de mélanger le talon dans la pioche
...
CentrePlateau piocher(Carte *pioche, int taillePioche, JoueurPoker *j, CentrePlateau centre, int nombreJoueurs)
{
  ...
  { //distribution des premières cartes des joueurs
    j[i].joueur = i + 1;
  ...
  for (int i = 0; i < nombreJoueurs; i++)
  { //distribution des secondes cartes des joueurs
